% skrypt tworzy dwa sygnały okresowe (sin i cos)
% i oblicza ich sumy

% Dane wejsciowe
Tk = 1;           % czas trwania sygnału w sekundach
fs = 1000;         % czesttliwosc. próbkowania w [Hz]
f1 = 2;           % czestotliwosc pierwszego sygnału
f2 = 10;          % czestotliwosc drugiego sygnału
A1 = 1;A2 = 1;  % aplitudy sygnałów
