...
void displayTreeMenu(string info)
{
  cout << endl;
  cout << info << endl;
  cout << "1.Wczytaj z pliku" << endl;
  cout << "2.Usun" << endl;
  cout << "3.Usun bez DSW" << endl;
  cout << "4.Dodaj" << endl;
  cout << "5.Dodaj bez DSW" << endl;
  cout << "6.Znajdz" << endl;
  cout << "7.Utworz losowo" << endl;
  cout << "8.Wyswietl" << endl;
  cout << "9.Wyczysc wszystko" << endl;
  cout << "0.Powrot do menu" << endl;
  cout << "Podaj opcje:";
}
...
void menu_tree()
{
  ...
  do{
    ...
    case '5':
      cout << " podaj wartosc:";
      cin >> value;
      my_tree.push_back_DSW_free(value);
      my_tree.display();      
      break;
    ...
    case '7':  //tutaj generowanie  tablicy
      cout << "Podaj ilosc elementów tablicy:";
      cin >> value;
    ...
    case '8':  //tutaj wyœwietlanie tablicy
      my_tree.display();
      break;
